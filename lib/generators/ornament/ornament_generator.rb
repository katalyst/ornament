class OrnamentGenerator < Rails::Generators::Base
  ...
  def components
    if options.components?
      ...
      copy_file "app/assets/javascripts/components/tooltips.js"
      ...
      copy_file "app/assets/stylesheets/components/_tooltips.css.scss"
      copy_file "app/assets/stylesheets/components/_credit-card.css.scss"
    end
  end
