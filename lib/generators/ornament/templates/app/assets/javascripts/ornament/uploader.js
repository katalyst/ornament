...
Ornament.uploader.makeThumbnailForUploader = function(cropObject, thumbnailObject) {
  ...
  if(cropObject.w === 0 && cropObject.h === 0) {
    ...
    if(thumbnailObject.ratio > actualRatio) {
      var offset = (actualHeight / 2) - (thumbnailHeight * widthDifference / 2);
    ...
    // If wider
      ...
      var offset = (actualWidth / 2) - (thumbnailWidth * heightDifference / 2);
...
Ornament.uploader.manageCoords = function(c) {
  ...
  if(c.h === 0 && c.w === 0) {
    ...
    var $thumbnail = $file.next().find(".thumb");
