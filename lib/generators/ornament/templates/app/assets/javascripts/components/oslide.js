    ...
    oslide: function(options) {
      ...
      return this.each(function() {
        ...
        var updateMinimap = function(){
          ...
          // update width of marker with percentage of visible slides
          $minimapMarker.width(getPercentageOfVisibleSlides() + "%");
          // update position of marker with percentage progressed
