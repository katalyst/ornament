    ...
    oslide: function(options) {
      ...
      return this.each(function() {
        ...
        var isLastSlideVisible = function(){
          // var currentScrollPosition = getCurrentSlideOffset();
          // var widthOfSlider = $oslide.width();
          // var widthOfSlideItems = getWidthNeededForSlides();
          // debugger;

          // get full width
          // (offset + one + width) > fullwidth

          // debugger;

          if( (getCurrentSlideOffset() + $oslideContainer.width()) > getWidthNeededForSlides() ) {
            return true;
          } else {
            return false;
          }

          // return lastSlideIsVisible;
        }
        ...
        var goToSlide = function(index){
          ...
          // console.log( getCurrentSlideIndex(), getCurrentSlideOffset() );
