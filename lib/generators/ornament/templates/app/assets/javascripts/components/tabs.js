...
(function (document, window, $) {
  ...
  $(document).on("ornament:refresh", function () {
    ...
    var scaffoldSwipeTabs = function($tabset){
      ...
      var $swipeTargets = $tabset.find(".tabs-links, .tabs-links ul, .tabs-links a");
      $swipeTargets.swipe({
        ...
        swipeStatus: function(event, phase, direction, distance, duration, fingers){
          ...
          if($movableElement.is(":animated")) {return false;}
      ...
      // Removing click events on swipable tabs
      // Rebinding using "tap"
      $tabset.find(".tabs-links a").off("click").swipe({
