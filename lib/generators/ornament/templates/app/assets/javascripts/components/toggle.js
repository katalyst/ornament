  ...
  var Toggle = {
    ...
    getTogglesInGroup: function($anchor,inclusive){
      ...
      if(inclusive) {
        ...
        return Ornament.nodeListArray($anchors).filter(function($node){
          return $node !== $anchor;
        });
      }
    },
    ...
    scrollToMasterAnchor: function($anchor) {
      ...
      var $master = Ornament.nodeListArray($allAnchors).filter(function($node){
    ...
    init: function(){
      ...
      this.$anchors.forEach(function($anchor){
        ...
        if($anchor.hasAttribute(Toggle.temporaryAnchorSelector)) {
          ...
          // document.removeEventListener("click", listenForThisPaneClick);
          // document.addEventListener("click", listenForThisPaneClick);
