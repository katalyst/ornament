  ...
  var Toggle = {
    ...
    scrollToMasterAnchor: function($anchor) {
      ...
      if(scrollTop > masterOffsetTop) {
        Ornament.U.bodyScroll(masterOffsetTop, Toggle.getToggleTiming($master));
      }
    },
    ...
    toggleOn: function($anchor, $pane){
      ...
      // Show the pane
      Ornament.$.slideDown($pane[0], Toggle.getToggleTiming($anchor), function(){
    ...
    toggleOff: function($anchor, $pane){
      ...
      // Hide the pane
      Ornament.$.slideUp($pane[0], Toggle.getToggleTiming($anchor), function(){
    ...
    afterToggleOn: function($anchor, $pane){
      Ornament.triggerEvent($anchor[0], Toggle.eventNameSpace + "toggled-on");
      Ornament.triggerEvent($pane[0], Toggle.eventNameSpace + "toggled-on");
    ...
    afterToggleOff: function($anchor, $pane){
      Ornament.triggerEvent($anchor[0], Toggle.eventNameSpace + "toggled-off");
      Ornament.triggerEvent($pane[0], Toggle.eventNameSpace + "toggled-off");
    },
    ...
    hideAllToggles: function(){
      Toggle.$panes.each(function(){
        var $pane = $(this);
        if($pane.is("[" + Toggle.defaultPaneSelector + "]")) {
          return;
        }
        Ornament.$.slideUp($pane[0], 1);
      });
    },
    ...
    init: function(){
      ...
      this.$anchors.each(function(){
        ...
        Ornament.U.bindOnce($anchor[0], Toggle.eventNameSpace + "toggle-on", function(){
          Toggle.toggleOn($anchor, $pane);
        });
        Ornament.U.bindOnce($anchor[0], Toggle.eventNameSpace + "toggle-off", function(){
          Toggle.toggleOff($anchor, $pane);
        });
        Ornament.U.bindOnce($anchor[0], Toggle.eventNameSpace + "toggle", function(){
          Toggle.toggle($anchor, $pane);
        });
        Ornament.U.bindOnce($pane[0], Toggle.eventNameSpace + "toggle-on", function(){
          Toggle.toggleOn($anchor, $pane);
        });
        Ornament.U.bindOnce($pane[0], Toggle.eventNameSpace + "toggle-off", function(){
          Toggle.toggleOff($anchor, $pane);
        });
        Ornament.U.bindOnce($pane[0], Toggle.eventNameSpace + "toggle", function(){
          Toggle.toggle($anchor, $pane);
        });
