...
(function (document, window, $) {
  ...
  $(document).on("ornament:refresh", function () {
    ...
    window.mobileNav = {
      ...
      paneClass:               "pane",
      nonPaneClass:            "non-pane",
      hasChildren:             "has-children",
      activeClass:             "activeClass",

      // Selectors
      tray:                    $(".layout--mobile-tray"),
      contentElement:          $(".layout--content"),
      layoutElement:           $(".layout"),
      anchor:                  $(".layout--switch"),
      ourPanes:                $(self.paneClass),
      ourNonPanes:             $(self.nonPaneClass),

      // Settings
      simple:                  false,
      animationDuration:       500,
      animationBuffer:         100,
      animationTiming:         self.animationDuration + self.animationBuffer,
    ...
    // Clicking on menu items will move to the next item
    mobileNav.find(".has-children").on("click", function(e){
      e.preventDefault();
      return false;
    });
