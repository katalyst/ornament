...
(function (document, window, $) {
  ...
  $(document).on("ornament:refresh", function () {
    ...
    window.mobileNav = {
      ...
      isOpen: function() {
        return mobileNav.layoutElement.hasClass(mobileNav.layoutOpenClass);
      },

      // Return a true if the menu is transitioning 
      isTransitioning: function() {
        return mobileNav.layoutElement.hasClass(mobileNav.layoutTransitionClass);
      },
      ...
      closeMenu: function(){
        ...
        if(mobileNav.keepScrollPosition) {
          mobileNav.closeTimeout = setTimeout(function(){
            mobileNav.layoutPositioner.css({
              position: "static",
              top: 0
            });
      ...
      openMenu: function(){
        ...
        if(mobileNav.keepScrollPosition) {
          clearTimeout(mobileNav.closeTimeout);
          if(!mobileNav.isTransitioning()) {
      ...
      scaffoldMobileMenu: function(){
        ...
        mobileNav.getNestedMenus().each(function(){
          ...
          // add the back button
          $nestedNode.prepend("<li class='" + mobileNav.backContainerClass + "'><a href='#' class='" + mobileNav.backButtonClass + "' data-mobilenav-back>" + (mobileNav.svgSupport ? Ornament.icons.chevron : false) + mobileNav.backText + "</a></li>");
        });
