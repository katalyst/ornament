...
(function (document, window, $) {
  ...
  $(document).on("ornament:refresh", function () {
    ...
    var ReadMore = Ornament.Components.ReadMore = {
      ...
      moreLabelSelecotr: "data-read-more-label",
      ...
      getHeightOfContainer: function($element){
        return Ornament.measure($element);
      },
      ...
      setupContainer: function($content) {
        ...
        var moreMaxHeight = ReadMore.getHeightOfContainer($content);
