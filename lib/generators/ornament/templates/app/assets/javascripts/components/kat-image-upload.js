/* ==================================================
  ...
  TODO:
  * Seperate ratio from croppable
  * Size thumbnail on init based on ratio
  * Add nicer ajax error message 
  * Add nicer format error message 
    ...
    katFileUpload: function(options) {
      ...
      return this.each(function() {
        ...
        var setThumbnailRatio = function(){
          if(parseInt(imageRatio) !== 1) {
            $thumbnailContainer.width(80 * parseInt(imageRatio));
          }
        }
        ...
        var initialiseCrop = function($image, currentCrop){
          $image.Jcrop({
            ...
            aspectRatio: parseInt(imageRatio),
        ...
        $dropZoneText.append($messageDefault).append($messageUploading).append($messageSaving);
