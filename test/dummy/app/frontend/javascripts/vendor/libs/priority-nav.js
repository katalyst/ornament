// THIS HAS BEEN MODIFIED BY KATALYST
// Please be careful when updating
// Search for KATALYST references
...
(function (root, factory) {
    ...
    var calculateWidths = function (_this) {
        ...
        var dropdownElement = _this.querySelector(navDropdown);
        if(dropdownElement) {
            if (dropdownElement.parentNode === _this) {
    ...
    var showToggle = function (_this, identifier) {
        // KATALYST EDIT - check element exists before modifying
        var dropdownElement = _this.querySelector(navDropdownToggle);
        if(dropdownElement) {
            if (breaks[identifier].length < 1) {
                dropdownElement.classList.add("priority-nav-is-hidden");
                dropdownElement.classList.remove("priority-nav-is-visible");
                ...
                dropdownElement.classList.add("priority-nav-is-visible");
                dropdownElement.classList.remove("priority-nav-is-hidden");
    ...
    var listeners = function (_this, settings) {
        ...
        _this.querySelector(navDropdownToggle).addEventListener("click", function () {
            // KATALYST EDIT - checking dropdown element before attempting to modify
            var dropdownElement = _this.querySelector(navDropdown);
            if(dropdownElement) {
                toggleClass(dropdownElement, "show");
        ...
        document.addEventListener("click", function (event) {
            ...
            if (!getClosest(event.target, "."+settings.navDropdownClassName) && event.target !== _this.querySelector(navDropdownToggle)) {
                // KATALYST EDIT - checking elements exist before modifying
                var dropdownElement = _this.querySelector(navDropdown);
                if(dropdownElement) {
                    dropdownElement.classList.remove("show");
                }
                var toggleElement = _this.querySelector(navDropdownToggle);
                if(toggleElement) {
        ...
        document.onkeydown = function (evt) {
            ...
            if (evt.keyCode === 27) {
                // KATALYST EDIT - checking elements exist before modifying
                var dropdownElement = document.querySelector(navDropdown);
                if(dropdownElement) {
                    dropdownElement.classList.remove("show");
                }
                var toggleElement = document.querySelector(navDropdownToggle);
                if(toggleElement) {
                    toggleElement.classList.remove("is-open");
                }
                if(mainNavWrapper) {
